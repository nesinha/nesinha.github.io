...
function($scope,$location, $anchorScroll){
 ...
 {Event:'Software Engineer - 1',Desc:'Promoted to Software Engineer 1. We moved to .Net MVC and got opprotunity to work on more challenging projects.',On:'July-1-2014'},
 {Event:'Trainee Software Engineer',Desc:'Joined Microchip Technology in Bangalore as Trainee Software Engineer. I joined an amazing team at MCHP - internet and intranet application team. We used .Net framework 3.5 c# webform application, Sql mainly. I was an integral part of microchips e-commerce website microchipdirect.com.',On:'July-1-2013'},
 {Event:'Bachelors in Computer Science',Desc:'Graduated from MSRIT with the degree in Bachelors of Computer Science.',On:'June-2013'},
 {Event:'Joined MSRIT',Desc:'I joined M.S. Ramaiah Institute of Technology, Bangalore, India to pursue bachelors in Computer Science. MSRIT is one the top five college in the state of karnataka. Checkout wiki for more information.',On:'Sept-09-2009'}
 ];
